...
<div class="container">
    <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
        <div class="col-10 col-sm-8 col-lg-6">
            <img src="<?=getAnimauxImage($animal['image']);?>" class="d-block mx-lg-auto img-fluid shadow-lg p-3 mb-5 bg-warning rounded"
             alt="<?=$animal['race']; ?>" width="700"
